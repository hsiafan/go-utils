...
func TestArrayDeque(t *testing.T) {
	for _, deque := range []Deque[int]{
		NewArrayDeque[int](),
		NewLinkedListDeque[int](),
	} {
...
func TestArrayDequeWithString(t *testing.T) {
	for _, deque := range []Deque[string]{NewArrayDeque[string](), NewLinkedListDeque[string]()} {
...
func TestArrayDequeEmpty(t *testing.T) {
	for _, deque := range []Deque[int]{NewArrayDeque[int](), NewLinkedListDeque[int]()} {
...
func TestDequeResizing(t *testing.T) {
